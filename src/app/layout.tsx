...
export const metadata: Metadata = {
  title: "Siddhant Jain — Developer & Product Builder",
  description:
    "Portfolio of Siddhant Jain. CS & Business at SFU. Open to opportunities in product, consulting, and software development.",
};
